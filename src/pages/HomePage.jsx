...
const HomePage = () => {
  ...
  <div className="pt-2 pb-2">
    <div className="container brands">
          ...
          <div className="col-sm-6 col-lg-4">
            <div className="banner banner-overlay">
              ...
              <div className="banner-content">
                ...
                <h3 className="banner-title"><a href="#"><strong>Sandals &amp; <br />Flip Flops</strong> <br />up to 60% off</a></h3>{/* End .banner-title */}
      ...
      <div className="owl-carousel mt-3 mb-3 owl-simple" data-toggle="owl" data-owl-options="{
                      &quot;nav&quot;: false, 
                      &quot;dots&quot;: false,
                      &quot;margin&quot;: 30,
                      &quot;loop&quot;: false,
  ...
  <div className="mb-3 mb-xl-2" />{/* End .mb-3 */}
  <div className="trending">
    ...
    <div className="banner banner-big d-md-block">
      <div className="banner-content text-center">
        ...
        <a href="category.html" className="btn btn-primary-white"><span>Shop Now</span><i className="icon-long-arrow-right" /></a>
      </div>{/* End .banner-content */}
    </div>{/* End .banner */}
  </div>
  ...
  <div className="container recent-arrivals">
    ...
    <div className="tab-content">
      ...
      <div className="more-container text-center mt-3 mb-3">
        <a href="category.html" className="btn btn-outline-dark-3 btn-more"><span>View More</span><i className="icon-long-arrow-right" /></a>

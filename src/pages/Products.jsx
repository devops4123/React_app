              ...
              <div className="product-details">
                ...
                <div className="details-filter-row details-row-size">
                  ...
                  <div className="product-nav product-nav-thumbs">
                    {['1', '2'].map((num, index) => (
                      <a key={index} href={index === 0 ? '#' : ''} className={index === 0 ? 'active' : ''}>
                ...
                <div className="product-details-footer">
                  ...
                  <div className="social-icons social-icons-sm">
                    ...
                    {['facebook-f', 'twitter', 'instagram', 'pinterest'].map((icon, index) => (
                      <a key={index} href="#" className="social-icon" title={icon} target="_blank">
            ...
            <div className="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                ...
                <div className="product product-7 text-center">
                    ...
                    <div className="product-body">
                        ...
                        <h3 className="product-title"><a href="product.html">White gold plated princess <br />cut diamond ring</a></h3>
